...
REM x8632bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0-arm64.exe
REM Date             : 20251007
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
...
:section_3_1
    if exist "python-3.11.0-*.<" (
        echo. Found existing version of Python 3.11.x
        del python-3.11.*-*.exe
        del python-3.11.*.exe
...
:section_3_4
    ...
    echo.
    echo. You may need to press ENTER, If the wait time is more than 10 seconds. 
    echo. Otherwise, if it crashed, Press CTRL-C.
    echo. Continuing...................
    echo.
...
:check_arch
    ...
    if /i "%processor_architecture%"=="x86" (
            rem Run 32bit INTEL downloader
