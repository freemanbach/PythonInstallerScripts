...
curl -C - -O https://www.python.org/ftp/python/3.14.0/python-3.14.0-macos11.pkg 
################################
...
sudo installer -verboseR -pkg python-3.14.0-macos11.pkg -target /Applications
###############################
...
# install Packages
#############################
/Library/Frameworks/Python.framework/Versions/3.14/bin/python3 -m pip install --user wheel scrapy
/Library/Frameworks/Python.framework/Versions/3.14/bin/python3 -m pip install --user pipx
/Library/Frameworks/Python.framework/Versions/3.14/bin/python3 -m pip install --user pandas polars matplotlib
/Library/Frameworks/Python.framework/Versions/3.14/bin/python3 -m pip install --user scikit-learn
##############################

#############################
# Printing version
#############################
/Library/Frameworks/Python.framework/Versions/3.14/bin/python3 -c "import sys; print(sys.executable)"
