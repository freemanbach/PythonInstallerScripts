...
REM x8632bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a4.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a4-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a4-arm64.exe
REM Date             : 2025.01.27
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
...
:start_this
    ...
    set /p _value=Are you sure installing Python-3.14.0 Alpha release 4 x86_64, x86 or ARM64 (y/[n]) ?
