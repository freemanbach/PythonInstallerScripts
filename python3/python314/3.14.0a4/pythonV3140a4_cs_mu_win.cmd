...
REM 32bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a4.exe
REM 64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a4-amd64.exe
REM Date          : 2025.01.27
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.14.0 Alpha Candidate 4 x86-64 or x86 (y/[n]) ?
