...
#        : for version 3.14.0 Alpha release 4
# Date   : 2025.01.27
################################
...
curl -C - -O https://www.python.org/ftp/python/3.14.0/python-3.14.0a4-macos11.pkg
################################

###############################
# install Python Software
echo "Enter in your normal login password, when prompted !"
sudo installer -verboseR -pkg python-3.14.0a4-macos11.pkg -target /Applications
###############################
