...
REM 32bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a2.exe
REM 64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0a2-amd64.exe
REM Date          : 2024.11.22
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.14.0 Alpha Candidate 2 x86-64 or x86 (y/[n]) ?
