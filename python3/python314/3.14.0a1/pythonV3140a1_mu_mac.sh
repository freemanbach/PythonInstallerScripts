...
#        : for version 3.14.0 Alpha release 1
# Date   : 2024.10.27
################################
...
curl -C - -O https://www.python.org/ftp/python/3.14.0/python-3.14.0a1-macos11.pkg
################################

###############################
# install Python Software
echo "Enter in your normal login password, when prompted !"
sudo installer -verboseR -pkg python-3.14.0a1-macos11.pkg -target /Applications
###############################
