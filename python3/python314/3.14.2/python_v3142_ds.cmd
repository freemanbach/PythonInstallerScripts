...
REM x8632bit path    : https://www.python.org/ftp/python/3.14.2/python-3.14.2.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.14.2/python-3.14.2-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.14.2/python-3.14.2-arm64.exe
REM Date             : 20251222
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
...
:section_15
    ...
    REM Run this Auto generated --runme.bat-- inside a DOS prompt before using Python 3.14.X
