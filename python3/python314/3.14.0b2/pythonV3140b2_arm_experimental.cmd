...
REM x8632bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0b2.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0b2-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.14.0/python-3.14.0b2-arm64.exe
REM Date             : 20250529
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
...
:start_this
    ...
    set /p _value=Are you sure installing Python-%major%.%minor%.%patch% Beta release 2 x86_64, x86 or ARM64 (y/[n]) ?
