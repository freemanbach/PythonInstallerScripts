...
#        : for version 3.14.0 Beta release 2
# Date   : 20250529
################################
...
curl -C - -O https://www.python.org/ftp/python/3.14.0/python-3.14.0b2-macos11.pkg
################################

###############################
# install Python Software
echo "Enter in your normal login password, when prompted !"
sudo installer -verboseR -pkg python-3.14.0b2-macos11.pkg -target /Applications
###############################
