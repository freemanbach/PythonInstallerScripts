...
REM x8632bit path    : https://www.python.org/ftp/python/3.14.3/python-3.14.3.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.14.3/python-3.14.3-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.14.3/python-3.14.3-arm64.exe
REM Date             : 20260307
REM -----------------------------------------------------------------------------------
set major=3
set minor=14
