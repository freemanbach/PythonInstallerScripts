...
curl -C - -O https://www.python.org/ftp/python/3.9.14/python-3.9.14-macos11.pkg 
################################

###############################
# install Python Software
echo "Enter in your normal login password, when prompted !"
sudo installer -verboseR -pkg python-3.9.14-macos11.pkg -target /Applications
###############################
...
#
##############################
# Cant get some of these installed without installing XCode First
