...
REM 32bit path    : https://www.python.org/ftp/python/3.9.14/python-3.9.14.exe
REM 64bit path    : https://www.python.org/ftp/python/3.9.14/python-3.9.14-amd64.exe
REM Date          : 2022.12.18
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.9.14 x86_64 and x86 (y/[n]) ?
    if /i "%_value%" NEQ "y" goto end

:: This batch file will show details Windows 10, and install Python v3.9.14
:section_0
    setlocal
