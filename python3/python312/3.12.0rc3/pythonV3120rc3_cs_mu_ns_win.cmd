...
REM 32bit path    : https://www.python.org/ftp/python/3.12.0/python-3.12.0rc3.exe
REM 64bit path    : https://www.python.org/ftp/python/3.12.0/python-3.12.0rc3-amd64.exe
REM Date          : 2023.09.26
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.12.0 Release Candidate 3 x86-64 or x86 (y/[n]) ?
...
:section_15
    ...
    REM Run this Auto generated --runme%major%%minor%%patch%%release%.bat-- inside a DOS prompt before using Python 3.12.Xrc3
