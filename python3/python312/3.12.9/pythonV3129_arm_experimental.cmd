...
REM ARM64bit path    : https://www.python.org/ftp/python/3.12.9/python-3.12.9-arm64.exe
REM Date             : 2025.03.25
REM -----------------------------------------------------------------------------------
set major=3
set minor=12
...
:start_this
    ...
    set /p _value=Are you sure installing Python-3.12.9 x86_64, x86 or ARM64 (y/[n]) ?
