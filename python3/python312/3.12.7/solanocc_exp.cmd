...
:start_this
    ...
    set /p _value=Are you sure installing Python-3.12.7 x86_64, x86 or ARM64 (y/[n]) ?
...
:section_10
    ...
    if exist C:\Python%major%%minor%%patch%\python.exe (
        if exist C:\Python%major%%minor%%patch%%release%\Scripts\pip.exe (
            echo.
            echo. Checking whether Python PIP has been installed...
            echo.
            echo. Python PIP Software has been Installed.
            echo.
        ) else (
            echo.
            echo. Python PIP Software has not been installed.
            echo.
            echo. line 349
            goto end
        )
