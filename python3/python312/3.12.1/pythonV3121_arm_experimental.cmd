...
REM x8632bit path    : https://www.python.org/ftp/python/3.12.1/python-3.12.1.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.12.1/python-3.12.1-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.12.1/python-3.12.1-arm64.exe
REM Date             : 2023.12.10
REM -----------------------------------------------------------------------------------
set major=3
set minor=12
...
:start_this
    ...
    set /p _value=Are you sure installing Python-3.12.1 x86_64, x86 or ARM64 (y/[n]) ?
