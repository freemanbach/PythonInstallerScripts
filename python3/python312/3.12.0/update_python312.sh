...
if [[ -f "$DATA" ]]; then
    ...
    /Library/Frameworks/Python.framework/Versions/3.12/bin/pip3 freeze > req.txt
    /Library/Frameworks/Python.framework/Versions/3.12/bin/pip3 install -r req.txt --upgrade
    # Delete req.txt file
