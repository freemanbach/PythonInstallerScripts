...
curl -C - -O https://www.python.org/ftp/python/3.12.0/python-3.12.0-macos11.pkg 
################################

################################
# There isnt a pkg installer file for *JUST* M1/M2 CPUs from the Python Community
...
sudo installer -verboseR -pkg python-3.12.0-macos11.pkg -target /Applications
###############################
