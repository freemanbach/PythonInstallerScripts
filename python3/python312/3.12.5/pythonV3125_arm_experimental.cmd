...
REM x8632bit path    : https://www.python.org/ftp/python/3.12.5/python-3.12.5.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.12.5/python-3.12.5-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.12.5/python-3.12.5-arm64.exe
REM Date             : 2024.08.20
REM -----------------------------------------------------------------------------------
set major=3
set minor=12
