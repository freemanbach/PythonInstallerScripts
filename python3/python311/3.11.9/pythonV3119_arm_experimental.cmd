...
REM x8632bit path    : https://www.python.org/ftp/python/3.11.9/python-3.11.9.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.11.9/python-3.11.9-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.11.9/python-3.11.9-arm64.exe
REM Date             : 2024.09.16
REM -----------------------------------------------------------------------------------
set major=3
set minor=11
...
:start_this
    ...
    set /p _value=Are you sure installing Python-3.11.9 x86_64, x86 or ARM64 (y/[n]) ?
...
:section_15
    ...
    if exist C:\Users\%USERNAME%\Downloads\python-%major%.%minor%.%patch%-amd64.exe (
        REM deleting 64 bit AMD64 installer
    ...
    if exist C:\Users\%USERNAME%\Downloads\python-%major%.%minor%.%patch%-arm64.exe (
        REM deleting 64 bit ARM64 installer
        echo. deleting installation file
    ...
    if exist C:\Users\%USERNAME%\Downloads\python-%major%.%minor%.%patch%.exe (
            REM deleting 32 bit X86 installer
            echo. deleting installation file
