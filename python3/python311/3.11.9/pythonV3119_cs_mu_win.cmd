...
REM 32bit path    : https://www.python.org/ftp/python/3.11.9/python-3.11.9.exe
REM 64bit path    : https://www.python.org/ftp/python/3.11.9/python-3.11.9-amd64.exe
REM Date          : 2024.04.10
REM -----------------------------------------------------------------------------------
set major=3
set minor=11
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.11.9 x86-64 or x86 (y/[n]) ?
