...
REM 32bit path    : https://www.python.org/ftp/python/3.11.7/python-3.11.7.exe
REM 64bit path    : https://www.python.org/ftp/python/3.11.7/python-3.11.7-amd64.exe
REM Date          : 2023.12.10
REM -----------------------------------------------------------------------------------
set major=3
set minor=11
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.11.7 x86-64 or x86 (y/[n]) ?
