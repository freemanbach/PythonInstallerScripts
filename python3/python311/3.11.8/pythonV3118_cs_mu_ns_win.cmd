...
REM 32bit path    : https://www.python.org/ftp/python/3.11.8/python-3.11.8.exe
REM 64bit path    : https://www.python.org/ftp/python/3.11.8/python-3.11.8-amd64.exe
REM Date          : 2024.02.07
REM -----------------------------------------------------------------------------------
set major=3
set minor=11
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.11.8 x86-64 or x86 (y/[n]) ?
