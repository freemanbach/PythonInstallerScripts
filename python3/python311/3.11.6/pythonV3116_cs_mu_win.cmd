...
REM 32bit path    : https://www.python.org/ftp/python/3.11.6/python-3.11.6.exe
REM 64bit path    : https://www.python.org/ftp/python/3.11.6/python-3.11.6-amd64.exe
REM Date          : 2023.10.02
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.11.6 x86-64 or x86 (y/[n]) ?
