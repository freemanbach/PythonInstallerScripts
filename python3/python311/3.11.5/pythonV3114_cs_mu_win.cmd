...
REM 32bit path    : https://www.python.org/ftp/python/3.11.5/python-3.11.5.exe
REM 64bit path    : https://www.python.org/ftp/python/3.11.5/python-3.11.5-amd64.exe
REM Date          : 2023.08.02
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.11.5 x86-64 or x86 (y/[n]) ?
