...
REM 32bit path    : https://www.python.org/ftp/python/3.10.11/python-3.10.11.exe
REM 64bit path    : https://www.python.org/ftp/python/3.10.11/python-3.10.11-amd64.exe
REM Date          : 2023.05.03
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.10.11 x86_64 or x86 (y/[n]) ?
