...
#        : for version 3.13.0 RC release 2
# Date   : 2024.09.14
################################
...
curl -C - -O https://www.python.org/ftp/python/3.13.0/python-3.13.0rc2-macos11.pkg
################################

###############################
# install Python Software
echo "Enter in your normal login password, when prompted !"
sudo installer -verboseR -pkg python-3.13.0rc2-macos11.pkg -target /Applications
###############################
