...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.2/python-3.13.2.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.2/python-3.13.2-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.2/python-3.13.2-arm64.exe
REM Date             : 20250209
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
