...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0-arm64.exe
REM Date             : 2024.10.16
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
