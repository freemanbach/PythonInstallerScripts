...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0b4.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0b4-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0b4-arm64.exe
REM Date             : 2024.07.22
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
