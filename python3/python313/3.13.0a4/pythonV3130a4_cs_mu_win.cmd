...
REM 32bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0a4.exe
REM 64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0a4-amd64.exe
REM Date          : 2024.03.06
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.13.0 Alpha Candidate 4 x86-64 or x86 (y/[n]) ?
