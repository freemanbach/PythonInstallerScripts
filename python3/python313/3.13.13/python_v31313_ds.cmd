...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.13/python-3.13.13.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.13/python-3.13.13-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.13/python-3.13.13-arm64.exe
REM Date             : 20260510
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
