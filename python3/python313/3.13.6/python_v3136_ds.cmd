...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.6/python-3.13.6.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.6/python-3.13.6-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.6/python-3.13.6-arm64.exe
REM Date             : 20250817
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
