...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.10/python-3.13.10.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.10/python-3.13.10-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.10/python-3.13.10-arm64.exe
REM Date             : 20251223
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
