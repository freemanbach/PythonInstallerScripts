...
REM 32bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0rc3.exe
REM 64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0rc3-amd64.exe
REM Date          : 2024.10.04
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
...
:start_this
    setlocal
    set _value="n"
    set /p _value=Are you sure installing Python-3.13.0 RC 3 Candidate x86-64 or x86 (y/[n]) ?
