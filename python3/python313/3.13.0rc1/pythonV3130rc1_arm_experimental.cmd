...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0rc1.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0rc1-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0rc1-arm64.exe
REM Date             : 2024.09.01
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
...
:check_arch
    ...
    if /i "%processor_architecture%"=="arm64" (
            rem Run 64bit downloader
            %badmin64% /transfer PythonDownload /download /priority normal https://www.python.org/ftp/python/%major%.%minor%.%patch%/python-%major%.%minor%.%patch%%release%-arm64.exe C:\Users\%USERNAME%\Downloads\python-%major%.%minor%.%patch%%release%-arm64.exe
        )
    echo. 40%% Completed.
    echo.
