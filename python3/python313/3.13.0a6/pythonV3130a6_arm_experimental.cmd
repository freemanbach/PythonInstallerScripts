...
REM x8632bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0a6.exe
REM AMD64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0a6-amd64.exe
REM ARM64bit path    : https://www.python.org/ftp/python/3.13.0/python-3.13.0a6-arm64.exe
REM Date             : 2024.05.06
REM -----------------------------------------------------------------------------------
set major=3
set minor=13
...
:start_this
    ...
    set /p _value=Are you sure installing Python-3.13.0 Alpha release 6 x86_64, x86 or ARM64 (y/[n]) ?
